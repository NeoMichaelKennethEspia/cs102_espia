...
url <- "https://www.amazon.com/s?k=vans&crid=3VRIHY8U227OY&sprefix=van%2Caps%2C798&ref=nb_sb_noss_2"
...
write.csv(product_df2, "SecondCategory.csv")

product_df2$Category <- "Vans"
